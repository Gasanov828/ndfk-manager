...
export default function ChampionshipHeader({
  ...
  return (
    <header className="tournament-header mb-2">
      <div className="tournament-hero relative overflow-hidden rounded-[16px] border border-amber-300/15 px-2.5 py-2 sm:px-3 sm:py-2.5">
        <div className="relative z-[1] flex items-center justify-between gap-2">
          <div className="min-w-0">
            <div className="flex min-w-0 items-center gap-2">
              <span className="tournament-cup-mark" aria-hidden>🏆</span>
